...
ALTER TABLE leads
  ...
  ADD COLUMN IF NOT EXISTS reponses_campagnes INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS visites_realisees INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS visiteur_id UUID,
  ADD COLUMN IF NOT EXISTS client_id UUID,
  ADD COLUMN IF NOT EXISTS notes TEXT,
  ADD COLUMN IF NOT EXISTS consentement_marketing BOOLEAN DEFAULT FALSE,
  ADD COLUMN IF NOT EXISTS consentement_le DATE,
...
CREATE INDEX IF NOT EXISTS idx_leads_derniere_interaction ON leads(derniere_interaction DESC);
...
CREATE INDEX IF NOT EXISTS idx_campagnes_canal ON campagnes(canal);
CREATE INDEX IF NOT EXISTS idx_campagnes_type ON campagnes(type);
CREATE INDEX IF NOT EXISTS idx_campagnes_date_envoi ON campagnes(date_envoi);
...
CREATE INDEX IF NOT EXISTS idx_lead_campagnes_lead ON lead_campagnes(lead_id);
CREATE INDEX IF NOT EXISTS idx_lead_campagnes_campagne ON lead_campagnes(campagne_id);
CREATE INDEX IF NOT EXISTS idx_lead_campagnes_statut ON lead_campagnes(statut);
...
CREATE INDEX IF NOT EXISTS idx_visites_terrain_lead ON visites_terrain(lead_id);
CREATE INDEX IF NOT EXISTS idx_visites_terrain_client ON visites_terrain(client_id);
CREATE INDEX IF NOT EXISTS idx_visites_terrain_terrain ON visites_terrain(terrain_id);
CREATE INDEX IF NOT EXISTS idx_visites_terrain_agent ON visites_terrain(agent_id);
CREATE INDEX IF NOT EXISTS idx_visites_terrain_date ON visites_terrain(date_visite DESC);
CREATE INDEX IF NOT EXISTS idx_visites_terrain_resultat ON visites_terrain(resultat);
...
CREATE INDEX IF NOT EXISTS idx_ventes_client ON ventes_foncieres(client_id);
CREATE INDEX IF NOT EXISTS idx_ventes_terrain ON ventes_foncieres(terrain_id);
CREATE INDEX IF NOT EXISTS idx_ventes_statut ON ventes_foncieres(statut);
CREATE INDEX IF NOT EXISTS idx_ventes_date_reservation ON ventes_foncieres(date_reservation DESC);
CREATE INDEX IF NOT EXISTS idx_ventes_agent ON ventes_foncieres(agent_id);
