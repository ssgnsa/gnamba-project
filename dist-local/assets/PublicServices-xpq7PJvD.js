...
import { r as v } from "./index-J6Ma0lNi.js";
var e = g(),
  f = {
    blue: {
...
function N({ onNavigate: o }) {
  const { get: t } = v(),
    c = [
      {
        id: "btp",
        icon: u,
        title: t("services", "btp_title", "BTP & Construction"),
      ...
      },
      {
        id: "immobilier",
        icon: x,
        title: t("services", "immobilier_title", "Immobilier"),
      ...
      },
      {
        id: "foncier",
        icon: b,
        title: t("services", "foncier_title", "Foncier"),
          ...
          (0, e.jsxs)("div", {
            ...
            children: [
              ...
              (0, e.jsx)("p", {
                ...
                children:
                  "Des solutions complètes et sur mesure pour tous vos besoins en BTP, immobilier, foncier et fournitures professionnelles.",
              }),
            ],
          }),
        ],
          ...
          children: c.map((s, m) => {
            ...
            return (0, e.jsxs)(
              "div",
              {
                ...
                children: [
                  (0, e.jsxs)("div", {
                    className: l ? "lg:order-2" : "",
                    children: [
                      (0, e.jsxs)("div", {
                        className: `inline-flex items-center gap-2 ${r.badge} rounded-full px-3 py-1.5 text-xs font-semibold mb-4`,
                        children: [(0, e.jsx)(a, { size: 13 }), s.title],
                      }),
                      (0, e.jsx)("h2", {
                          ...
                          (0, e.jsxs)(
                            "li",
                            {
                              ...
                              children: [
                                (0, e.jsx)(h, {
                                  size: 17,
                                  className: `${r.check} mt-0.5 flex-shrink-0`,
                                }),
                                (0, e.jsx)("span", {
                      ...
                      (0, e.jsxs)("button", {
                        ...
                        className:
                          "flex items-center gap-2 px-6 py-3 bg-blue-700 hover:bg-blue-800 text-white rounded-xl text-sm font-semibold transition-all shadow-sm",
                        children: [
                          (0, e.jsx)(n, { size: 15 }),
                          "Demander un devis",
                          (0, e.jsx)(p, { size: 15 }),
                  ...
                  (0, e.jsx)("div", {
                    className: l ? "lg:order-1" : "",
                    children: (0, e.jsxs)("div", {
                      className: `bg-gradient-to-br ${r.bg} rounded-3xl p-8 relative overflow-hidden`,
                      children: [
                        (0, e.jsx)("div", {
                          className:
                            "absolute -top-6 -right-6 w-24 h-24 bg-white/10 rounded-full",
                        }),
                        (0, e.jsx)("div", {
                          className:
                            "absolute -bottom-6 -left-6 w-32 h-32 bg-white/5 rounded-full",
                        }),
                        (0, e.jsxs)("div", {
                          ...
                          children: [
                            (0, e.jsx)("div", {
                              className:
                                "w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-6",
                              children: (0, e.jsx)(a, {
                                size: 32,
                            ...
                            (0, e.jsx)("div", {
                              className: "space-y-3",
                              children: s.examples.map((i) =>
                                (0, e.jsxs)(
                                  "div",
                                  {
                                    className:
                                      "flex items-center gap-3 bg-white/10 rounded-xl px-4 py-3",
                                    children: [
                                      (0, e.jsx)("div", {
                                        className:
                                          "w-2 h-2 bg-white/60 rounded-full flex-shrink-0",
                                      }),
                                      (0, e.jsx)("span", {
        ...
        children: (0, e.jsxs)("div", {
          ...
          children: [
            ...
            (0, e.jsx)("p", {
              ...
              children:
                "Contactez notre équipe pour obtenir un devis gratuit et personnalisé.",
            }),
            (0, e.jsxs)("button", {
              onClick: () => {
              ...
              className:
                "inline-flex items-center gap-2 px-8 py-3.5 bg-blue-700 hover:bg-blue-800 text-white rounded-xl font-semibold transition-all shadow-md",
              children: [
                (0, e.jsx)(n, { size: 17 }),
