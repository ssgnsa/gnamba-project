import { t as M } from "./rolldown-runtime-2JzG8er9.js";
var tt = M((o, u) => {
    u.exports = function () {
      return (
  ...
  nt = M((o, u) => {
    ...
    ((s.prototype.set = function (n, t, e, r) {
      const i = n * this.size + t;
      ((this.data[i] = e), r && (this.reservedBit[i] = !0));
    }),
      (s.prototype.get = function (n, t) {
        return this.data[n * this.size + t];
      }),
      (s.prototype.xor = function (n, t, e) {
        this.data[n * this.size + t] ^= e;
      }),
      (s.prototype.isReserved = function (n, t) {
        return this.reservedBit[n * this.size + t];
      }),
      (u.exports = s));
  }),
  rt = M((o) => {
    var u = D().getSymbolSize;
    ((o.getRowColCoords = function (n) {
      if (n === 1) return [];
      const t = Math.floor(n / 7) + 2,
        e = u(n),
        r = e === 145 ? 26 : Math.ceil((e - 13) / (2 * t - 2)) * 2,
        i = [e - 7];
      for (let a = 1; a < t - 1; a++) i[a] = i[a - 1] - r;
  ...
  ot = M((o) => {
    ...
    ((o.isValid = function (t) {
      ...
      (o.getPenaltyN1 = function (t) {
        ...
        for (let N = 0; N < e; N++) {
          ...
          for (let d = 0; d < e; d++) {
            ...
            (f === l
              ? i++
              : (i >= 5 && (r += u.N1 + (i - 5)), (l = f), (i = 1)),
              (f = t.get(d, N)),
              f === c
                ? a++
                : (a >= 5 && (r += u.N1 + (a - 5)), (c = f), (a = 1)));
          }
          (i >= 5 && (r += u.N1 + (i - 5)), a >= 5 && (r += u.N1 + (a - 5)));
        }
        return r;
      }),
      ...
      (o.getPenaltyN3 = function (t) {
        ...
        for (let l = 0; l < e; l++) {
          i = a = 0;
          for (let c = 0; c < e; c++)
            ((i = ((i << 1) & 2047) | t.get(l, c)),
              c >= 10 && (i === 1488 || i === 93) && r++,
              (a = ((a << 1) & 2047) | t.get(c, l)),
              c >= 10 && (a === 1488 || a === 93) && r++);
        }
        return r * u.N3;
      }),
      (o.getPenaltyN4 = function (t) {
        ...
        return Math.abs(Math.ceil((e * 100) / r / 5) - 10) * u.N4;
      }));
    function s(n, t, e) {
      switch (n) {
    ...
    ((o.applyMask = function (t, e) {
      ...
      for (let i = 0; i < r; i++)
        for (let a = 0; a < r; a++)
          e.isReserved(a, i) || e.xor(a, i, s(t, a, i));
    }),
      (o.getBestMask = function (t, e) {
        const r = Object.keys(o.Patterns).length;
        let i = 0,
          a = 1 / 0;
        for (let l = 0; l < r; l++) {
          (e(l), o.applyMask(l, t));
  ...
  Q = M((o) => {
    ...
    ((o.getBlocksCount = function (e, r) {
      ...
      (o.getTotalCodewordsCount = function (e, r) {
        switch (r) {
          case u.L:
            return n[(e - 1) * 4 + 0];
          case u.M:
  ...
  at = M((o) => {
    var u = new Uint8Array(512),
      s = new Uint8Array(256);
    ((function () {
      let t = 1;
      for (let e = 0; e < 255; e++)
        ((u[e] = t), (s[t] = e), (t <<= 1), t & 256 && (t ^= 285));
      for (let e = 255; e < 512; e++) u[e] = u[e - 255];
    })(),
      (o.log = function (t) {
  ...
  ut = M((o) => {
    ...
    ((o.mul = function (n, t) {
      ...
      for (let r = 0; r < n.length; r++)
        for (let i = 0; i < t.length; i++) e[r + i] ^= u.mul(n[r], t[i]);
      return e;
    }),
      (o.mod = function (n, t) {
        ...
        for (; e.length - t.length >= 0; ) {
          const r = e[0];
          for (let a = 0; a < t.length; a++) e[a] ^= u.mul(t[a], r);
          let i = 0;
          for (; i < e.length && e[i] === 0; ) i++;
          e = e.slice(i);
        }
        return e;
      }),
      (o.generateECPolynomial = function (n) {
        ...
        for (let e = 0; e < n; e++) t = o.mul(t, new Uint8Array([1, u.exp(e)]));
        return t;
      }));
  }),
  st = M((o, u) => {
  ...
  W = M((o) => {
    ...
    ((o.KANJI = new RegExp(n, "g")),
      (o.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g")),
      (o.BYTE = new RegExp(t, "g")),
      (o.NUMERIC = new RegExp(u, "g")),
      (o.ALPHANUMERIC = new RegExp(s, "g")));
    var e = new RegExp("^" + n + "$"),
      r = new RegExp("^" + u + "$"),
      i = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
    ((o.testKanji = function (l) {
      return e.test(l);
    }),
      (o.testNumeric = function (l) {
        return r.test(l);
      }),
      (o.testAlphanumeric = function (l) {
        return i.test(l);
      }));
  }),
  k = M((o) => {
    ...
    ((o.NUMERIC = { id: "Numeric", bit: 1, ccBits: [10, 12, 14] }),
      ...
      (o.MIXED = { bit: -1 }),
      (o.getCharCountIndicator = function (e, r) {
        if (!e.ccBits) throw new Error("Invalid mode: " + e);
        if (!u.isValid(r)) throw new Error("Invalid version: " + r);
        return r >= 1 && r < 10
          ? e.ccBits[0]
          : r < 27
            ? e.ccBits[1]
      ...
      (o.getBestModeForData = function (e) {
        return s.testNumeric(e)
          ? o.NUMERIC
          : s.testAlphanumeric(e)
            ? o.ALPHANUMERIC
            : s.testKanji(e)
              ? o.KANJI
              : o.BYTE;
  ...
  lt = M((o) => {
    var u = D(),
      ...
      i = u.getBCHDigit(r);
    function a(d, f, B) {
      for (let v = 1; v <= 40; v++) if (f <= o.getCapacity(v, B, d)) return v;
    }
    function l(d, f) {
      return t.getCharCountIndicator(d, f) + 4;
    }
    function c(d, f) {
      let B = 0;
      return (
    ...
    function N(d, f) {
      for (let B = 1; B <= 40; B++)
        if (c(d, B) <= o.getCapacity(B, f, t.MIXED)) return B;
    }
    ((o.from = function (f, B) {
      return e.isValid(f) ? parseInt(f, 10) : B;
    }),
      (o.getCapacity = function (f, B, v) {
        if (!e.isValid(f)) throw new Error("Invalid QR Code version");
        typeof v > "u" && (v = t.BYTE);
        const S =
          (u.getSymbolTotalCodewords(f) - s.getTotalCodewordsCount(f, B)) * 8;
        if (v === t.MIXED) return S;
        const p = S - l(v, f);
        switch (v) {
          case t.NUMERIC:
      ...
      (o.getBestVersionForData = function (f, B) {
        let v;
        const S = n.from(B, n.M);
        if (Array.isArray(f)) {
          if (f.length > 1) return N(f, S);
          if (f.length === 0) return 1;
          v = f[0];
        } else v = f;
        return a(v.mode, v.getLength(), S);
      }),
      (o.getEncodedBits = function (f) {
        if (!e.isValid(f) || f < 7) throw new Error("Invalid QR Code version");
        let B = f << 12;
        for (; u.getBCHDigit(B) - i >= 0; ) B ^= r << (u.getBCHDigit(B) - i);
        return (f << 12) | B;
      }));
  }),
  ft = M((o) => {
    var u = D(),
      ...
      n = 21522,
      t = u.getBCHDigit(s);
    o.getEncodedBits = function (r, i) {
      const a = (r.bit << 3) | i;
      let l = a << 10;
      for (; u.getBCHDigit(l) - t >= 0; ) l ^= s << (u.getBCHDigit(l) - t);
      return ((a << 10) | l) ^ n;
    };
  }),
  ct = M((o, u) => {
    ...
    ((n.getBitsLength = function (e) {
      ...
      (n.prototype.write = function (e) {
        ...
        for (r = 0; r + 3 <= this.data.length; r += 3)
          ((i = this.data.substr(r, 3)), (a = parseInt(i, 10)), e.put(a, 10));
        const l = this.data.length - r;
        l > 0 &&
          ((i = this.data.substr(r)),
          (a = parseInt(i, 10)),
          e.put(a, l * 3 + 1));
      }),
      (u.exports = n));
    ...
    ((t.getBitsLength = function (r) {
      ...
      (t.prototype.write = function (r) {
        ...
        for (i = 0; i + 2 <= this.data.length; i += 2) {
          let a = n.indexOf(this.data[i]) * 45;
          ((a += n.indexOf(this.data[i + 1])), r.put(a, 11));
        }
        this.data.length % 2 && r.put(n.indexOf(this.data[i]), 6);
      }),
      (u.exports = t));
  }),
  dt = M((o, u) => {
...
Make sure your charset is UTF-8`,
    ...
    var s = {
      single_source_shortest_paths: function (n, t, e) {
        var r = {},
          i = {};
        i[t] = 0;
        var a = s.PriorityQueue.make();
        a.push(t, 0);
        for (var l, c, N, d, f, B, v, S, p; !a.empty(); ) {
      ...
      extract_shortest_path_from_predecessor_list: function (n, t) {
        for (var e = [], r = t; r; ) (e.push(r), n[r], (r = n[r]));
        return (e.reverse(), e);
      },
      find_path: function (n, t, e) {
        var r = s.single_source_shortest_paths(n, t, e);
        return s.extract_shortest_path_from_predecessor_list(r, e);
      },
      PriorityQueue: {
        make: function (n) {
          var t = s.PriorityQueue,
            e = {},
            r;
          n = n || {};
  ...
  mt = M((o) => {
    ...
    function c(p, T, I) {
      ...
      let P;
      for (; (P = p.exec(I)) !== null; )
        E.push({ data: P[0], index: P.index, mode: T, length: P[0].length });
      return E;
    }
    function N(p) {
      const T = c(r.NUMERIC, u.NUMERIC, p),
        I = c(r.ALPHANUMERIC, u.ALPHANUMERIC, p);
      let E, P;
      return (
        i.isKanjiModeEnabled()
          ? ((E = c(r.BYTE, u.BYTE, p)), (P = c(r.KANJI, u.KANJI, p)))
          : ((E = c(r.BYTE_KANJI, u.BYTE, p)), (P = [])),
        T.concat(I, E, P)
          .sort(function (R, m) {
      ...
      for (let I = 0; I < p.length; I++) {
        ...
        switch (E.mode) {
          case u.NUMERIC:
            T.push([
              E,
              { data: E.data, mode: u.ALPHANUMERIC, length: E.length },
              { data: E.data, mode: u.BYTE, length: E.length },
            ]);
            break;
          case u.ALPHANUMERIC:
            T.push([E, { data: E.data, mode: u.BYTE, length: E.length }]);
            break;
          case u.KANJI:
            T.push([E, { data: E.data, mode: u.BYTE, length: l(E.data) }]);
            break;
          case u.BYTE:
            T.push([{ data: E.data, mode: u.BYTE, length: l(E.data) }]);
        }
      }
      return T;
    }
    function v(p, T) {
      ...
      for (let R = 0; R < p.length; R++) {
        ...
        for (let C = 0; C < m.length; C++) {
          const g = m[C],
            A = "" + R + C;
          (_.push(A), (I[A] = { node: g, lastCount: 0 }), (E[A] = {}));
          for (let h = 0; h < P.length; h++) {
            const w = P[h];
            I[w] && I[w].node.mode === g.mode
              ? ((E[w][A] =
                  d(I[w].lastCount + g.length, g.mode) -
                  d(I[w].lastCount, g.mode)),
                (I[w].lastCount += g.length))
              : (I[w] && (I[w].lastCount = g.length),
                (E[w][A] =
                  d(g.length, g.mode) +
                  4 +
                  u.getCharCountIndicator(g.mode, T)));
          }
        }
        P = _;
      }
      for (let R = 0; R < P.length; R++) E[P[R]].end = 0;
      return { map: E, table: I };
    }
    function S(p, T) {
      let I;
      const E = u.getBestModeForData(p);
      if (((I = u.from(T, E)), I !== u.BYTE && I.bit < E.bit))
        throw new Error(
          '"' +
            p +
 ...
 Suggested mode is: ` +
      ...
      switch ((I === u.KANJI && !i.isKanjiModeEnabled() && (I = u.BYTE), I)) {
        case u.NUMERIC:
          return new s(p);
        case u.ALPHANUMERIC:
          return new n(p);
    ...
    ((o.fromArray = function (T) {
      return T.reduce(function (I, E) {
        return (
          typeof E == "string"
            ? I.push(S(E, null))
            : E.data && I.push(S(E.data, E.mode)),
          I
        );
      }, []);
    }),
      (o.fromString = function (T, I) {
        const E = v(B(N(T, i.isKanjiModeEnabled())), I),
          P = a.find_path(E.map, "start", "end"),
          R = [];
        for (let m = 1; m < P.length - 1; m++) R.push(E.table[P[m]].node);
        return o.fromArray(f(R));
      }),
      (o.rawSplit = function (T) {
        return o.fromArray(N(T, i.isKanjiModeEnabled()));
      }));
  }),
  yt = M((o) => {
    var u = D(),
    ...
    function v(m) {
      ...
      for (let C = 8; C < _ - 8; C++) {
        const g = C % 2 === 0;
        (m.set(C, 6, g, !0), m.set(6, C, g, !0));
      }
    }
    function S(m, _) {
      const C = e.getPositions(_);
      for (let g = 0; g < C.length; g++) {
        const A = C[g][0],
          h = C[g][1];
        for (let w = -2; w <= 2; w++)
          for (let y = -2; y <= 2; y++)
            w === -2 || w === 2 || y === -2 || y === 2 || (w === 0 && y === 0)
              ? m.set(A + w, h + y, !0, !0)
              : m.set(A + w, h + y, !1, !0);
      }
    }
    ...
    function I(m, _) {
      ...
      for (let y = C - 1; y > 0; y -= 2)
        for (y === 6 && y--; ; ) {
          for (let b = 0; b < 2; b++)
            if (!m.isReserved(A, y - b)) {
              let F = !1;
              (w < _.length && (F = ((_[w] >>> h) & 1) === 1),
                m.set(A, y - b, F),
                h--,
                h === -1 && (w++, (h = 7)));
            }
    ...
    function E(m, _, C) {
      ...
      C.forEach(function (w) {
        (g.put(w.mode.bit, 4),
          g.put(w.getLength(), d.getCharCountIndicator(w.mode, m)),
          w.write(g));
      });
      const A =
        (u.getSymbolTotalCodewords(m) - a.getTotalCodewordsCount(m, _)) * 8;
      for (
        g.getLengthInBits() + 4 <= A && g.put(0, 4);
        g.getLengthInBits() % 8 !== 0;
      )
        g.putBit(0);
      const h = (A - g.getLengthInBits()) / 8;
      for (let w = 0; w < h; w++) g.put(w % 2 ? 17 : 236, 8);
      return P(g, m, _);
    }
    function P(m, _, C) {
      const g = u.getSymbolTotalCodewords(_),
        A = g - a.getTotalCodewordsCount(_, C),
        h = a.getBlocksCount(_, C),
        w = h - (g % h),
        y = Math.floor(g / h),
        b = Math.floor(A / h),
        F = b + 1,
      ...
      const z = new Array(h),
        j = new Array(h);
      let H = 0;
      const x = new Uint8Array(m.buffer);
      for (let q = 0; q < h; q++) {
        const J = q < w ? b : F;
        ((z[q] = x.slice(V, V + J)),
          (j[q] = X.encode(z[q])),
      ...
      let G = 0,
        ...
        U;
      for (L = 0; L < H; L++)
        for (U = 0; U < h; U++) L < z[U].length && (K[G++] = z[U][L]);
      for (L = 0; L < O; L++) for (U = 0; U < h; U++) K[G++] = j[U][L];
      return K;
    }
    function R(m, _, C, g) {
      let A;
      if (Array.isArray(m)) A = f.fromArray(m);
      else if (typeof m == "string") {
        let b = _;
        if (!b) {
          const F = f.rawSplit(m);
          b = c.getBestVersionForData(F, C);
        }
        A = f.fromString(m, b || 40);
      } else throw new Error("Invalid data");
      const h = c.getBestVersionForData(A, C);
      if (!h)
        throw new Error(
...
`,
      ...
      return (
        ...
        _ >= 7 && p(y, _),
        I(y, w),
        isNaN(g) && (g = i.getBestMask(y, T.bind(null, y, C))),
        i.applyMask(g, y),
        T(y, C, g),
        {
          modules: y,
    ...
    o.create = function (_, C) {
      ...
      return (
        typeof C < "u" &&
          ((g = s.from(C.errorCorrectionLevel, s.M)),
          (A = c.from(C.version)),
          (h = i.from(C.maskPattern)),
          C.toSJISFunc && u.setToSJISFunction(C.toSJISFunc)),
        R(_, A, g, h)
      );
    };
  }),
  Z = M((o) => {
    ...
    ((o.getOptions = function (n) {
      ...
      return {
        ...
        margin: t,
        color: {
          dark: u(n.color.dark || "#000000ff"),
          light: u(n.color.light || "#ffffffff"),
        },
        type: n.type,
      ...
      (o.qrToImageData = function (n, t, e) {
        const r = t.modules.size,
          i = t.modules.data,
          a = o.getScale(r, e),
          l = Math.floor((r + e.margin * 2) * a),
          c = e.margin * a,
          N = [e.color.light, e.color.dark];
        for (let d = 0; d < l; d++)
          for (let f = 0; f < l; f++) {
            let B = (d * l + f) * 4,
              v = e.color.light;
            if (d >= c && f >= c && d < l - c && f < l - c) {
              const S = Math.floor((d - c) / a),
                p = Math.floor((f - c) / a);
              v = N[i[S * r + p] ? 1 : 0];
            }
            ((n[B++] = v.r), (n[B++] = v.g), (n[B++] = v.b), (n[B] = v.a));
          }
      }));
  }),
  Et = M((o) => {
    ...
    ((o.render = function (e, r, i) {
      let a = i,
        l = r;
      (typeof a > "u" && (!r || !r.getContext) && ((a = r), (r = void 0)),
        r || (l = n()),
        (a = u.getOptions(a)));
      const c = u.getImageWidth(e.modules.size, a),
        N = l.getContext("2d"),
        d = N.createImageData(c, c);
      return (
        u.qrToImageData(d.data, e, a),
        s(N, l, c),
        N.putImageData(d, 0, 0),
        l
      );
    }),
      (o.renderToDataURL = function (e, r, i) {
        let a = i;
        (typeof a > "u" && (!r || !r.getContext) && ((a = r), (r = void 0)),
          a || (a = {}));
        const l = o.render(e, r, a),
          c = a.type || "image/png",
          N = a.rendererOpts || {};
        return l.toDataURL(c, N.quality);
      }));
  }),
  Ct = M((o) => {
    var u = Z();
    function s(e, r) {
      const i = e.a / 255,
        a = r + '="' + e.hex + '"';
      return i < 1
        ? a + " " + r + '-opacity="' + i.toFixed(2).slice(1) + '"'
        : a;
    }
    function n(e, r, i) {
      let a = e + r;
    ...
    function t(e, r, i) {
      ...
      for (let d = 0; d < e.length; d++) {
        const f = Math.floor(d % r),
          B = Math.floor(d / r);
        (!f && !c && (c = !0),
          e[d]
            ? (N++,
              (d > 0 && f > 0 && e[d - 1]) ||
                ((a += c ? n("M", f + i, 0.5 + B + i) : n("m", l, 0)),
                (l = 0),
                (c = !1)),
              (f + 1 < r && e[d + 1]) || ((a += n("h", N)), (N = 0)))
            : l++);
      }
      return a;
    }
    o.render = function (r, i, a) {
      const l = u.getOptions(i),
        c = r.modules.size,
        N = r.modules.data,
        d = c + l.margin * 2,
        f = l.color.light.a
          ? "<path " +
            s(l.color.light, "fill") +
            ' d="M0 0h' +
            d +
            "v" +
            d +
...
`;
  ...
  pt = M((o) => {
    var u = tt(),
      ...
      n = Et(),
      t = Ct();
    function e(r, i, a, l, c) {
      const N = [].slice.call(arguments, 1),
        d = N.length,
        f = typeof N[d - 1] == "function";
      if (!f && !u()) throw new Error("Callback required as last argument");
      if (f) {
        if (d < 2) throw new Error("Too few arguments provided");
        d === 2
          ? ((c = a), (a = i), (i = l = void 0))
          : d === 3 &&
            (i.getContext && typeof c > "u"
              ? ((c = l), (l = void 0))
              : ((c = l), (l = a), (a = i), (i = void 0)));
      } else {
        if (d < 1) throw new Error("Too few arguments provided");
        return (
          d === 1
            ? ((a = i), (i = l = void 0))
            : d === 2 && !i.getContext && ((l = a), (a = i), (i = void 0)),
          new Promise(function (B, v) {
            try {
              B(r(s.create(a, l), i, l));
            } catch (S) {
              v(S);
            }
          })
    ...
    ((o.create = s.create),
      (o.toCanvas = e.bind(null, n.render)),
      (o.toDataURL = e.bind(null, n.renderToDataURL)),
      (o.toString = e.bind(null, function (r, i, a) {
        return t.render(r, a);
      })));
  }),
  At = pt();
