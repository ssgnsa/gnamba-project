...
//#region node_modules/react-turnstile/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function Turnstile({ id, className, style: customStyle, sitekey, action, cData, theme, language, tabIndex, responseField, responseFieldName, size, fixedSize, retry, retryInterval, refreshExpired, appearance, execution, userRef, onVerify, onSuccess, onLoad, onError, onExpire, onTimeout, onAfterInteractive, onBeforeInteractive, onUnsupported }) {
		...
		(0, react_1.useEffect)(() => {
			...
			(async () => {
				var _a, _b;
				if (turnstileState !== "ready") try {
					await ensureTurnstile();
				} catch (e) {
					(_a = inplaceState.onError) === null || _a === void 0 || _a.call(inplaceState, e);
					return;
				}
				...
				const turnstileOptions = {
					...
					callback: (token, preClearanceObtained) => {
						var _a, _b;
						(_a = inplaceState.onVerify) === null || _a === void 0 || _a.call(inplaceState, token, boundTurnstileObject);
						(_b = inplaceState.onSuccess) === null || _b === void 0 || _b.call(inplaceState, token, preClearanceObtained, boundTurnstileObject);
					},
				...
				(_b = inplaceState.onLoad) === null || _b === void 0 || _b.call(inplaceState, widgetId, boundTurnstileObject);
			})();
			return () => {
				cancelled = true;
