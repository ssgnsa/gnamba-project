...
export const LotFormModal: FC<LotFormModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  initialData,
  ...
  const emptyFormState = useMemo<FormState>(() => ({
    numero_lot: "",
    numero_ilot: "",
    nom_lotissement: "",
    village: "",
    ...
    proprietaire_client_id: undefined,
  ...
  const convertOutputToInput = useCallback((data: Partial<FoncierLotFormInput>): FormState => {
    ...
    return {
      ...
      proprietaire_client_id: (data as any).proprietaire_client_id ?? undefined,
  ...
  useEffect(() => {
    if (initialData) {
      setFormData(convertOutputToInput(initialData));
    } else {
      setFormData(emptyFormState);
    }
    setError(null);
  }, [convertOutputToInput, emptyFormState, initialData, isOpen]);
