...
DROP POLICY IF EXISTS "tenant_isolation_animals_select" ON public.animals;
DROP POLICY IF EXISTS "tenant_isolation_animals_insert" ON public.animals;
DROP POLICY IF EXISTS "tenant_isolation_animals_update" ON public.animals;
DROP POLICY IF EXISTS "tenant_isolation_animals_delete" ON public.animals;
DROP POLICY IF EXISTS "tenant_isolation_fields_select" ON public.fields;
DROP POLICY IF EXISTS "tenant_isolation_fields_insert" ON public.fields;
DROP POLICY IF EXISTS "tenant_isolation_fields_update" ON public.fields;
DROP POLICY IF EXISTS "tenant_isolation_fields_delete" ON public.fields;
DROP POLICY IF EXISTS "tenant_isolation_crop_cycles_select" ON public.crop_cycles;
DROP POLICY IF EXISTS "tenant_isolation_crop_cycles_insert" ON public.crop_cycles;
DROP POLICY IF EXISTS "tenant_isolation_crop_cycles_update" ON public.crop_cycles;
DROP POLICY IF EXISTS "tenant_isolation_crop_cycles_delete" ON public.crop_cycles;
DROP POLICY IF EXISTS "tenant_isolation_crop_interventions_select" ON public.crop_interventions;
DROP POLICY IF EXISTS "tenant_isolation_crop_interventions_insert" ON public.crop_interventions;
DROP POLICY IF EXISTS "tenant_isolation_crop_interventions_update" ON public.crop_interventions;
DROP POLICY IF EXISTS "tenant_isolation_crop_interventions_delete" ON public.crop_interventions;
DROP POLICY IF EXISTS "tenant_isolation_harvests_select" ON public.harvests;
DROP POLICY IF EXISTS "tenant_isolation_harvests_insert" ON public.harvests;
DROP POLICY IF EXISTS "tenant_isolation_harvests_update" ON public.harvests;
DROP POLICY IF EXISTS "tenant_isolation_harvests_delete" ON public.harvests;
DROP POLICY IF EXISTS "tenant_isolation_buildings_select" ON public.buildings;
DROP POLICY IF EXISTS "tenant_isolation_buildings_insert" ON public.buildings;
DROP POLICY IF EXISTS "tenant_isolation_buildings_update" ON public.buildings;
DROP POLICY IF EXISTS "tenant_isolation_buildings_delete" ON public.buildings;
DROP POLICY IF EXISTS "tenant_isolation_building_types_select" ON public.building_types;
DROP POLICY IF EXISTS "tenant_isolation_building_types_insert" ON public.building_types;
DROP POLICY IF EXISTS "tenant_isolation_building_types_update" ON public.building_types;
DROP POLICY IF EXISTS "tenant_isolation_building_types_delete" ON public.building_types;
DROP POLICY IF EXISTS "tenant_isolation_construction_projects_select" ON public.construction_projects;
DROP POLICY IF EXISTS "tenant_isolation_construction_projects_insert" ON public.construction_projects;
DROP POLICY IF EXISTS "tenant_isolation_construction_projects_update" ON public.construction_projects;
DROP POLICY IF EXISTS "tenant_isolation_construction_projects_delete" ON public.construction_projects;
DROP POLICY IF EXISTS "tenant_isolation_cameras_select" ON public.cameras;
DROP POLICY IF EXISTS "tenant_isolation_cameras_insert" ON public.cameras;
DROP POLICY IF EXISTS "tenant_isolation_cameras_update" ON public.cameras;
DROP POLICY IF EXISTS "tenant_isolation_cameras_delete" ON public.cameras;
DROP POLICY IF EXISTS "tenant_isolation_counting_sessions_select" ON public.counting_sessions;
DROP POLICY IF EXISTS "tenant_isolation_counting_sessions_insert" ON public.counting_sessions;
DROP POLICY IF EXISTS "tenant_isolation_counting_sessions_update" ON public.counting_sessions;
DROP POLICY IF EXISTS "tenant_isolation_counting_sessions_delete" ON public.counting_sessions;
DROP POLICY IF EXISTS "tenant_isolation_customers_select" ON public.customers;
DROP POLICY IF EXISTS "tenant_isolation_customers_insert" ON public.customers;
DROP POLICY IF EXISTS "tenant_isolation_customers_update" ON public.customers;
DROP POLICY IF EXISTS "tenant_isolation_customers_delete" ON public.customers;
DROP POLICY IF EXISTS "tenant_isolation_equipment_select" ON public.equipment;
DROP POLICY IF EXISTS "tenant_isolation_equipment_insert" ON public.equipment;
DROP POLICY IF EXISTS "tenant_isolation_equipment_update" ON public.equipment;
DROP POLICY IF EXISTS "tenant_isolation_equipment_delete" ON public.equipment;
DROP POLICY IF EXISTS "tenant_isolation_financial_transactions_select" ON public.financial_transactions;
DROP POLICY IF EXISTS "tenant_isolation_financial_transactions_insert" ON public.financial_transactions;
DROP POLICY IF EXISTS "tenant_isolation_financial_transactions_update" ON public.financial_transactions;
DROP POLICY IF EXISTS "tenant_isolation_financial_transactions_delete" ON public.financial_transactions;
DROP POLICY IF EXISTS "tenant_isolation_health_records_select" ON public.health_records;
DROP POLICY IF EXISTS "tenant_isolation_health_records_insert" ON public.health_records;
DROP POLICY IF EXISTS "tenant_isolation_health_records_update" ON public.health_records;
DROP POLICY IF EXISTS "tenant_isolation_health_records_delete" ON public.health_records;
DROP POLICY IF EXISTS "tenant_isolation_livestock_events_select" ON public.livestock_events;
DROP POLICY IF EXISTS "tenant_isolation_livestock_events_insert" ON public.livestock_events;
DROP POLICY IF EXISTS "tenant_isolation_livestock_events_update" ON public.livestock_events;
DROP POLICY IF EXISTS "tenant_isolation_livestock_events_delete" ON public.livestock_events;
DROP POLICY IF EXISTS "tenant_isolation_lots_select" ON public.lots;
DROP POLICY IF EXISTS "tenant_isolation_lots_insert" ON public.lots;
DROP POLICY IF EXISTS "tenant_isolation_lots_update" ON public.lots;
DROP POLICY IF EXISTS "tenant_isolation_lots_delete" ON public.lots;
...
DROP POLICY IF EXISTS "tenant_isolation_inventory_categories_select" ON public.inventory_categories;
DROP POLICY IF EXISTS "tenant_isolation_inventory_categories_insert" ON public.inventory_categories;
DROP POLICY IF EXISTS "tenant_isolation_inventory_categories_update" ON public.inventory_categories;
DROP POLICY IF EXISTS "tenant_isolation_inventory_categories_delete" ON public.inventory_categories;
DROP POLICY IF EXISTS "tenant_isolation_inventory_items_select" ON public.inventory_items;
DROP POLICY IF EXISTS "tenant_isolation_inventory_items_insert" ON public.inventory_items;
DROP POLICY IF EXISTS "tenant_isolation_inventory_items_update" ON public.inventory_items;
DROP POLICY IF EXISTS "tenant_isolation_inventory_items_delete" ON public.inventory_items;
DROP POLICY IF EXISTS "tenant_isolation_inventory_movements_select" ON public.inventory_movements;
DROP POLICY IF EXISTS "tenant_isolation_inventory_movements_insert" ON public.inventory_movements;
DROP POLICY IF EXISTS "tenant_isolation_inventory_movements_update" ON public.inventory_movements;
DROP POLICY IF EXISTS "tenant_isolation_inventory_movements_delete" ON public.inventory_movements;
DROP POLICY IF EXISTS "species_select_all" ON public.species;
DROP POLICY IF EXISTS "species_write_tenant" ON public.species;
DROP POLICY IF EXISTS "breeds_select_all" ON public.breeds;
DROP POLICY IF EXISTS "breeds_write_tenant" ON public.breeds;
